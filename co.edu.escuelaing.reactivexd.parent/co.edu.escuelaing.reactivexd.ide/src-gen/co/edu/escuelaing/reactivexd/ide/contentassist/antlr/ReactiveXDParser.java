 ...
 */
package co.edu.escuelaing.reactivexd.ide.contentassist.antlr;

import co.edu.escuelaing.reactivexd.ide.contentassist.antlr.internal.InternalReactiveXDParser;
...
public class ReactiveXDParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ReactiveXDGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReactiveXDGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getDeclAccess().getAlternatives(), "rule__Decl__Alternatives");
			builder.put(grammarAccess.getNotEventAccess().getAlternatives(), "rule__NotEvent__Alternatives");
			builder.put(grammarAccess.getEventPredicateAccess().getAlternatives(), "rule__EventPredicate__Alternatives");
			builder.put(grammarAccess.getTypeReturnAccess().getAlternatives(), "rule__TypeReturn__Alternatives");
			builder.put(grammarAccess.getLocationAccess().getAlternatives(), "rule__Location__Alternatives");
			builder.put(grammarAccess.getLocationAccess().getAlternatives_1_1(), "rule__Location__Alternatives_1_1");
			...
			builder.put(grammarAccess.getObsrvDeclAccess().getGroup(), "rule__ObsrvDecl__Group__0");
			builder.put(grammarAccess.getObsrvAssigAccess().getGroup(), "rule__ObsrvAssig__Group__0");
			builder.put(grammarAccess.getOrEventAccess().getGroup(), "rule__OrEvent__Group__0");
			builder.put(grammarAccess.getOrEventAccess().getGroup_1(), "rule__OrEvent__Group_1__0");
			builder.put(grammarAccess.getAndEventAccess().getGroup(), "rule__AndEvent__Group__0");
			builder.put(grammarAccess.getAndEventAccess().getGroup_1(), "rule__AndEvent__Group_1__0");
			builder.put(grammarAccess.getUnaryExpresionAccess().getGroup(), "rule__UnaryExpresion__Group__0");
			...
			builder.put(grammarAccess.getTriggerAccess().getGroup_5_1(), "rule__Trigger__Group_5_1__0");
			builder.put(grammarAccess.getMSigAccess().getGroup(), "rule__MSig__Group__0");
			builder.put(grammarAccess.getMSigAccess().getGroup_3(), "rule__MSig__Group_3__0");
			builder.put(grammarAccess.getMSigAccess().getGroup_3_1(), "rule__MSig__Group_3_1__0");
			builder.put(grammarAccess.getMSigAccess().getGroup_5(), "rule__MSig__Group_5__0");
			builder.put(grammarAccess.getLocationAccess().getGroup_1(), "rule__Location__Group_1__0");
			builder.put(grammarAccess.getLocationAccess().getGroup_1_0(), "rule__Location__Group_1_0__0");
			builder.put(grammarAccess.getLocationAccess().getGroup_1_0_2(), "rule__Location__Group_1_0_2__0");
			builder.put(grammarAccess.getLocationAccess().getGroup_1_0_2_2(), "rule__Location__Group_1_0_2_2__0");
			builder.put(grammarAccess.getLocationAccess().getGroup_1_1_2(), "rule__Location__Group_1_1_2__0");
			...
			builder.put(grammarAccess.getModelAccess().getTypeDeclarationAssignment_2(), "rule__Model__TypeDeclarationAssignment_2");
			builder.put(grammarAccess.getObsrvDeclAccess().getTypeAssignment_2(), "rule__ObsrvDecl__TypeAssignment_2");
			builder.put(grammarAccess.getObsrvDeclAccess().getNameAssignment_4(), "rule__ObsrvDecl__NameAssignment_4");
			builder.put(grammarAccess.getObsrvDeclAccess().getAssignmentAssignment_6(), "rule__ObsrvDecl__AssignmentAssignment_6");
			builder.put(grammarAccess.getObsrvAssigAccess().getPropsAssignment_4(), "rule__ObsrvAssig__PropsAssignment_4");
			builder.put(grammarAccess.getOrEventAccess().getOpAssignment_1_1(), "rule__OrEvent__OpAssignment_1_1");
			builder.put(grammarAccess.getOrEventAccess().getRightAssignment_1_2(), "rule__OrEvent__RightAssignment_1_2");
			builder.put(grammarAccess.getAndEventAccess().getOpAssignment_1_1(), "rule__AndEvent__OpAssignment_1_1");
			builder.put(grammarAccess.getAndEventAccess().getRightAssignment_1_2(), "rule__AndEvent__RightAssignment_1_2");
			builder.put(grammarAccess.getAtomEventAccess().getEventTypeAssignment(), "rule__AtomEvent__EventTypeAssignment");
			builder.put(grammarAccess.getUnaryExpresionAccess().getOpAssignment_1(), "rule__UnaryExpresion__OpAssignment_1");
			builder.put(grammarAccess.getUnaryExpresionAccess().getExprAssignment_2(), "rule__UnaryExpresion__ExprAssignment_2");
			builder.put(grammarAccess.getTriggerAccess().getTriggerTypeAssignment_0(), "rule__Trigger__TriggerTypeAssignment_0");
			builder.put(grammarAccess.getTriggerAccess().getReturndefAssignment_2(), "rule__Trigger__ReturndefAssignment_2");
			builder.put(grammarAccess.getTriggerAccess().getEsigAssignment_3(), "rule__Trigger__EsigAssignment_3");
			builder.put(grammarAccess.getTriggerAccess().getParamsAssignment_5_0(), "rule__Trigger__ParamsAssignment_5_0");
			builder.put(grammarAccess.getTriggerAccess().getParamsAssignment_5_1_1(), "rule__Trigger__ParamsAssignment_5_1_1");
			builder.put(grammarAccess.getTypeReturnAccess().getAstkAssignment_0(), "rule__TypeReturn__AstkAssignment_0");
			builder.put(grammarAccess.getTypeReturnAccess().getJvmRefAssignment_1(), "rule__TypeReturn__JvmRefAssignment_1");
			builder.put(grammarAccess.getKindAttributeAccess().getLocatAssignment(), "rule__KindAttribute__LocatAssignment");
			builder.put(grammarAccess.getMSigAccess().getNameAssignment_1(), "rule__MSig__NameAssignment_1");
			builder.put(grammarAccess.getMSigAccess().getParamsAssignment_3_0(), "rule__MSig__ParamsAssignment_3_0");
			builder.put(grammarAccess.getMSigAccess().getParamsAssignment_3_1_1(), "rule__MSig__ParamsAssignment_3_1_1");
			builder.put(grammarAccess.getMSigAccess().getTypeAssignment_5_1(), "rule__MSig__TypeAssignment_5_1");
			builder.put(grammarAccess.getMSigAccess().getBodyAssignment_6(), "rule__MSig__BodyAssignment_6");
	...
	@Override
	protected InternalReactiveXDParser createParser() {
		InternalReactiveXDParser result = new InternalReactiveXDParser(null);
