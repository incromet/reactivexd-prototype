 ...
 */
package co.edu.escuelaing.reactivexd.serializer;
...
public class ReactiveXDSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ReactiveXDPackage.eINSTANCE)
			...
			case ReactiveXDPackage.OBSRV_ASSIG:
				sequence_ObsrvAssig(context, (ObsrvAssig) semanticObject); 
				return; 
			case ReactiveXDPackage.OBSRV_DECL:
				sequence_ObsrvDecl(context, (ObsrvDecl) semanticObject); 
				return; 
	...
	protected void sequence_AndEvent(ISerializationContext context, AndEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.AND_EVENT__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.AND_EVENT__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.AND_EVENT__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.AND_EVENT__RIGHT));
		}
	...
	protected void sequence_AtomEvent(ISerializationContext context, EventExpression semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__EVENT_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__EVENT_TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAtomEventAccess().getEventTypeEventPredicateParserRuleCall_0(), semanticObject.getEventType());
		feeder.finish();
	}
	...
	protected void sequence_KindAttribute(ISerializationContext context, KindAttribute semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.KIND_ATTRIBUTE__LOCAT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.KIND_ATTRIBUTE__LOCAT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getKindAttributeAccess().getLocatLocationParserRuleCall_0(), semanticObject.getLocat());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((name=QualifiedName? importSection=XImportSection typeDeclaration+=Decl+) | (name=QualifiedName? typeDeclaration+=Decl+) | typeDeclaration+=Decl+)?
	 */
	...
	/**
	 * Contexts:
	 *     ObsrvAssig returns ObsrvAssig
	 *
	 * Constraint:
	 *     props+=OrEvent*
	 */
	protected void sequence_ObsrvAssig(ISerializationContext context, ObsrvAssig semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     Decl returns ObsrvDecl
	 *     ObsrvDecl returns ObsrvDecl
	 *
	 * Constraint:
	 *     (type=EventType name=ID assignment=ObsrvAssig)
	 */
	protected void sequence_ObsrvDecl(ISerializationContext context, ObsrvDecl semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.OBSRV_DECL__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.OBSRV_DECL__TYPE));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.DECL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.DECL__NAME));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.OBSRV_DECL__ASSIGNMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.OBSRV_DECL__ASSIGNMENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getObsrvDeclAccess().getTypeEventTypeEnumRuleCall_2_0(), semanticObject.getType());
		feeder.accept(grammarAccess.getObsrvDeclAccess().getNameIDTerminalRuleCall_4_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getObsrvDeclAccess().getAssignmentObsrvAssigParserRuleCall_6_0(), semanticObject.getAssignment());
		feeder.finish();
	}
	...
	protected void sequence_OrEvent(ISerializationContext context, OrEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.OR_EVENT__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.OR_EVENT__LEFT));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.OR_EVENT__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.OR_EVENT__RIGHT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_UnaryExpresion(ISerializationContext context, UnaryEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.EVENT_EXPRESSION__OP));
			if (transientValues.isValueTransient(semanticObject, ReactiveXDPackage.Literals.UNARY_EVENT__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReactiveXDPackage.Literals.UNARY_EVENT__EXPR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
