...
public class ReactiveXDSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ReactiveXDGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ReactiveXDGrammarAccess) access;
	 ...
	 *     name=QualifiedName (ambiguity) typeDeclaration+=Decl
	 */
