...
@after {
	...
	(
		...
		{
			$current = $this_ObsrvDecl_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleObsrvDecl returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getObsrvDeclRule()); }
	iv_ruleObsrvDecl=ruleObsrvDecl
	{ $current=$iv_ruleObsrvDecl.current; }
	EOF;

// Rule ObsrvDecl
ruleObsrvDecl returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleObsrvAssig returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getObsrvAssigRule()); }
	iv_ruleObsrvAssig=ruleObsrvAssig
	{ $current=$iv_ruleObsrvAssig.current; }
	EOF;

// Rule ObsrvAssig
ruleObsrvAssig returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_Trigger_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_KindAttribute_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleLocation returns [String current=null]:
	{ newCompositeNode(grammarAccess.getLocationRule()); }
	iv_ruleLocation=ruleLocation
	{ $current=$iv_ruleLocation.current.getText(); }
	EOF;

// Rule Location
ruleLocation returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
