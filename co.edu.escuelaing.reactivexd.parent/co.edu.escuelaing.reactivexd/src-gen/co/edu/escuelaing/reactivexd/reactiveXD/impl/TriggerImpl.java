 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.escuelaing.reactivexd.reactiveXD.impl.TriggerImpl#getTriggerType <em>Trigger Type</em>}</li>
 *   <li>{@link co.edu.escuelaing.reactivexd.reactiveXD.impl.TriggerImpl#getReturndef <em>Returndef</em>}</li>
 *   <li>{@link co.edu.escuelaing.reactivexd.reactiveXD.impl.TriggerImpl#getEsig <em>Esig</em>}</li>
 *   <li>{@link co.edu.escuelaing.reactivexd.reactiveXD.impl.TriggerImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggerImpl extends EventPredicateImpl implements Trigger
{
  ...
  {
    return ReactiveXDPackage.Literals.TRIGGER;
  }
  ...
  public void setTriggerType(TPrefix newTriggerType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReactiveXDPackage.TRIGGER__TRIGGER_TYPE, oldTriggerType, triggerType));
  }
  ...
  public NotificationChain basicSetReturndef(JVMTYPE newReturndef, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReactiveXDPackage.TRIGGER__RETURNDEF, oldReturndef, newReturndef);
  ...
  public void setReturndef(JVMTYPE newReturndef)
  {
    if (newReturndef != returndef)
    {
      ...
      if (returndef != null)
        msgs = ((InternalEObject)returndef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReactiveXDPackage.TRIGGER__RETURNDEF, null, msgs);
      if (newReturndef != null)
        msgs = ((InternalEObject)newReturndef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReactiveXDPackage.TRIGGER__RETURNDEF, null, msgs);
      msgs = basicSetReturndef(newReturndef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReactiveXDPackage.TRIGGER__RETURNDEF, newReturndef, newReturndef));
  }
  ...
  public void setEsig(String newEsig)
  {
    ...
    esig = newEsig;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReactiveXDPackage.TRIGGER__ESIG, oldEsig, esig));
  }
  ...
  public EList<JvmTypeReference> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<JvmTypeReference>(JvmTypeReference.class, this, ReactiveXDPackage.TRIGGER__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ReactiveXDPackage.TRIGGER__RETURNDEF:
        return basicSetReturndef(null, msgs);
      case ReactiveXDPackage.TRIGGER__PARAMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReactiveXDPackage.TRIGGER__TRIGGER_TYPE:
        return getTriggerType();
      case ReactiveXDPackage.TRIGGER__RETURNDEF:
        return getReturndef();
      case ReactiveXDPackage.TRIGGER__ESIG:
        return getEsig();
      case ReactiveXDPackage.TRIGGER__PARAMS:
        return getParams();
    }
