...
import co.edu.escuelaing.reactivexd.ide.contentassist.antlr.PartialReactiveXDContentAssistParser;
import co.edu.escuelaing.reactivexd.ide.contentassist.antlr.ReactiveXDParser;
import co.edu.escuelaing.reactivexd.ide.contentassist.antlr.internal.InternalReactiveXDLexer;
import co.edu.escuelaing.reactivexd.ui.contentassist.ReactiveXDProposalProvider;
import co.edu.escuelaing.reactivexd.ui.editor.ReactiveXDEditor;
import co.edu.escuelaing.reactivexd.ui.labeling.ReactiveXDDescriptionLabelProvider;
import co.edu.escuelaing.reactivexd.ui.labeling.ReactiveXDLabelProvider;
import co.edu.escuelaing.reactivexd.ui.outline.ReactiveXDOutlineTreeProvider;
import co.edu.escuelaing.reactivexd.ui.quickfix.ReactiveXDQuickfixProvider;
import co.edu.escuelaing.reactivexd.validation.ReactiveXDValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link ReactiveXDUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractReactiveXDUiModule extends DefaultXbaseUiModule {

	public AbstractReactiveXDUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(co.edu.escuelaing.reactivexd.parser.antlr.internal.InternalReactiveXDLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalReactiveXDLexer.class).toProvider(LexerProvider.create(InternalReactiveXDLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return ReactiveXDValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ReactiveXDLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ReactiveXDDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ReactiveXDOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ReactiveXDQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ReactiveXDProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialReactiveXDContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("ReactiveXD Compare");
	}
